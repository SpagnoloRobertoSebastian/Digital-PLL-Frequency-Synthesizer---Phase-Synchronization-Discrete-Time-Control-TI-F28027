...
// historia del filtro
static float P_k_1;               // Producto Entrada al filtro en t= k-1
static float P_k;               // Entrada al filtro en t= k
static float Pm_k_1;            //  salida del filtro en t= k-1
static float Pm_k;               //  salida del filtro en t= k

// historia del compensador
static float Em_k_1;            // Entrada al compensador en t= k
...
static float SenialGenerada=0;               //salida v0
   ...
   // Input conditioning
   Referencia = (Input10V/5.0)-1;   //muesta de la entrada en t=k
   ...
   // Generar la se�al de salida vo en el instante k
